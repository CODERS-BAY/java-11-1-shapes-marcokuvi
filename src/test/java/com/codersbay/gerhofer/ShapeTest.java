...
public class ShapeTest {
    ...
    public void testGetArea() {
        Square square = new Square(Color.RED, true, 3.5, 3.5);
        Rectangle rectangle = new Rectangle(Color.RED, true, 2.5, 4.5);
    ...
    public void testGetPerimeter() {
        Square square = new Square(Color.RED, true, 3.5, 3.5);
        Rectangle rectangle = new Rectangle(Color.RED, true, 2.5, 4.5);
        Circle circle = new Circle(Color.RED, true, 4.5);
    ...
    public void testIfRadiusIsNeverZeroOrNegative() {
        assertThrows(IllegalArgumentException.class, () -> {
            Square square = new Square(Color.RED, true, -2.5, 2.5);
            Rectangle rectangle = new Rectangle(Color.RED, true, 2.5, -1.0);
            Circle circle = new Circle(Color.RED, true, 0);
        });
    }
}
